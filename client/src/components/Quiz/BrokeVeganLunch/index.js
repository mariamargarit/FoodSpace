  ...
  return (
    <>
      <PageWrapper>
        ...
        <ButtonWrapper>
          <Button1 href="/kebabhriscat">Kebab</Button1>
          ...
          <Button1 href="/ciorbahribi" style={{'animation-delay':'0.28s'}}>Soup</Button1>
          <Button1 href="/veggiedelite" style={{'animation-delay':'0.35s'}}>Sandwich</Button1>
          <Button1 href="/grinchburger" style={{'animation-delay':'0.42s'}}>Burger</Button1>
          ...
          <Button1 href="/quesadillaspanac" style={{'animation-delay':'0.63s'}}>Quesadilla</Button1>
